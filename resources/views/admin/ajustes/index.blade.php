            ...
            <div class="card-body">
                    <form action="{{ url('/admin/ajustes/create') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                                        ...
                                        <div class="form-group"> 
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="nombre" id="nombre"
                                                    ...
                                                    placeholder="Ej: Estacionamiento ABC" 
                                                    required>
                                            </div>
                                            @error('nombre')
                                        ...
                                        <div class="form-group"> 
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <textarea class="form-control" name="descripcion" id="descripcion" rows="1"
                                                    placeholder="Descripción..." required>{{ old('descripcion', $ajuste->descripcion ?? '') }}</textarea>
                                            </div>
                                            @error('descripcion')
                                                <small style="color: green">{{ $message }}</small>
                                            @enderror
                                        ...
                                        <div class="form-group"> 
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="telefonos" id="telefonos" 
                                                    value="{{ old('telefonos', $ajuste->telefonos ?? '') }}" placeholder="Ej: 985 235 478" required>
                                            </div>
                                            @error('telefonos')
                                                <small style="color: green">{{ $message }}</small>
                                            @enderror
                                        ...
                                        <div class="form-group"> 
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <select class="form-control" name="divisa" id="divisa"  required>
                                                    ...
                                                    @endforeach
                                                    {{-- <option value="S/" {{ old('divisa') == 'S/' ? 'selected' : '' }}>S/ - Soles</option>
                                                    <option value="$" {{ old('divisa') == '$' ? 'selected' : '' }}>$ - Dólares</option> --}}
                                                </select>    
                                            </div>
                                            @error('divisa')
                                                <small style="color: green">{{ $message }}</small>
                                        ...
                                        <div class="form-group"> 
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="email" class="form-control" name="correo" id="correo" 
                                                    value="{{ old('correo', $ajuste->correo ?? '') }}" placeholder="example@gmail.com"
                                                        required>                                            
                                            </div>
                                            @error('correo')
                                                <small style="color: green">{{ $message }}</small>
                                        ...
                                        <div class="form-group"> 
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="url" class="form-control" name="pagina_web" id="pagina_web" 
                                                    value="{{ old('pagina_web', $ajuste->pagina_web ?? '') }}" placeholder="https://www.example.com">                                            
                                            </div>
                                            @error('pagina_web')
                                                <small style="color: green">{{ $message }}</small>
                                            @enderror
                            ...
                            <div class="col-md-4"> {{-- para las imagenes --}}
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group"> 
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group"> 
                                            ...
                                            <center>
                                                ...
                                                @else   
                                                    <img id="preview2" src=""
                                                    style="max-width2: 200px; margin-top: 10px;">                                           
                                                @endif 
                                            </center>
                                            @error('logo_auto')
                                                <small style="color: green">{{ $message }}</small>
