                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group-prepend">
                                    ...
                                    <option value="regular" {{ old('nombre',$tarifa->nombre) == 'regular' ? 'selected' : '' }}> Tarifa Regular</option>
                                    <option value="nocturna" {{ old('nombre',$tarifa->nombre) == 'nocturna' ? 'selected' : '' }}> Tarifa Nocturna</option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="tipo" id="tipo" required>
                                    ...
                                    <option value="hora" {{ old('tipo',$tarifa->tipo) == 'hora' ? 'selected' : '' }}> Por hora</option>
                                    <option value="dia" {{ old('tipo',$tarifa->tipo) == 'dia' ? 'selected' : '' }}> Por dia</option>
                                    <option value="noche" {{ old('tipo',$tarifa->tipo) == 'noche' ? 'selected' : '' }}> Por noche</option>                                
                                </select>    
                                </div>
                                @error('tipo')
                                    <small style="color: red">{{ $message }}</small>                           
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="cantidad" id="cantidad" 
                                    min="0" value="{{ old('cantidad',$tarifa->cantidad) }}">
                                </div>
                            </div>    
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                value="{{ old('minutos_de_gracia',$tarifa->minutos_de_gracia) }}">
                            </div>
