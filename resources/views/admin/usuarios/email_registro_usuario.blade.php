...
<head>
    ...
    <title>Bienvenido a parkcore</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        .header {
            background: linear-gradient(135deg, #ff6b6b 0%, #853636 100%);
            color: white;
            padding: 40px 30px;
            text-align: center;
            position: relative;
...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <div class="info-card">
                <p style="margin-bottom: 15px; color: #2c3e50; font-size: 16px;">
                    Tu cuenta ha sido creada exitosamente en nuestro sistema parkcore.
        ...
        <div class="footer">
            <p><strong>Sistema Parkcore</strong></p>
